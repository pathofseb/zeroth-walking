...
class ZbotWalkingTask(ksim.PPOTask[ZbotWalkingTaskConfig]):
    ...
    def get_rewards(self, physics_model: ksim.PhysicsModel) -> dict[str, ksim.Reward]:
        ...
        rewards = [
            ...
            XYOrientationReward(scale=0.5),  # train5: Reduced for more lenient orientation
            OrientationPenalty(deadzone_rad=0.25, error_scale=0.15, scale=-2.0),  # train5: More lenient
